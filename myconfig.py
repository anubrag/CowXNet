...
filename='cow_all10.mp4'
#filename = 'all' 
videotype='.mp4'

checkcropping= False #set "True" if you want to check cropping 
cropping = False #set "True" if you want to crop images with values below
...
bodyparts = ["Body_Cow_A", "Body_Cow_B", "Body_Cow_C", "Bottom_Cow_A", "Bottom_Cow_B", "Bottom_Cow_C", "Nose_Cow_A", "Nose_Cow_B", "Nose_Cow_C"]  # Exact sequence of labels as were put by
# annotator in *.csv file (for multibodypartsfile). For single files order is irrelevant
Scorers = ['Sky']  # who is labeling?
...
invisibleboundary=float("nan") # If labels are closer to origin than this number they are set to NaN (not a number). Please adjust to your situation. Units in pixel.
